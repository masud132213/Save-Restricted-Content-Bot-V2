...
async def start(event):
    ...
    collection.update_one({"user_id": user_id}, {"$set": {"user_id": user_id}}, upsert=True)
    buttons = [
        [Button.url("Join Channel", url="https://t.me/saverestricted_BD")],
        [Button.url("Contact Me", url="https://t.me/saverestricted_BD")],
    ]
...
S = "/start"
START_PIC = "https://graph.org/file/4006435729f0e854ece90.png"
TEXT = "Hey! I am Advance Content Saver Bot, do login in bot by /login and start saving from public/private channels/groups via sending post link.\n\n👉🏻 Execute /batch for bulk process upto 10 files range."


M = "/plan"
PREMIUM_PIC = "https://t.me/saverestricted_BD"
...
async def plan_command(event):
    ...
    buttons = [
        [Button.url("Send Gift Card Code", url="https://t.me/saverestricted_BD")]
    ]
...
async def term_command(event):
    # Creating inline keyboard with buttons
    buttons = [
        [Button.url("Query?", url="https://t.me/saverestricted_BD"),
         Button.url("Channel", url="https://t.me/saverestricted_BD")]
    ]
...
REPO_URL = "https://t.me/saverestricted_BD"
